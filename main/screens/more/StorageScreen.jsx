            ...
            .then(res => {
                if (!res) {
                    ...
                    Toast.show({
                        ...
                        text2: t('screen_storage_button_delete_downloaded_failes_2', {
                            error: res.message,
                        }),
                    });
                }
                        ...
                        try {
                            ...
                            if (
                                ...
                                Toast.show({
                                    ...
                                    text2: t('screen_storage_button_import_backup_err_2', {
                                        error: err.message,
                                    }),
                                });
                            }
    ...
    return (
        <SafeAreaView style={[{ backgroundColor: currentTheme.backgroundColor }, styles.container]}>
            ...
            <ScrollView style={styles.content}>
                <View style={[styles.pageSection, { borderColor: currentTheme.borderColor }]}>
                    ...
                    >
                        ...
                        />
                        <Text
                            style={[{ color: currentTheme.textColor, paddingTop: 10 }, styles.text]}
                        >
                ...
                <Text
                    style={[
                        styles.text,
                        { color: currentTheme.secondaryTextColor, paddingTop: 10 },
                    ]}
                >
