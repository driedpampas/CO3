...
const HistoryScreen = ({
    ...
    const clearHistory = () => {
        Alert.alert(t('screen_history_clear_title'), t('screen_history_clear_text'), [
    ...
    if (loading) {
        return <LoadingSpinner currentTheme={currentTheme} message={t('screen_history_loading')} />;
    }
        ...
        <View style={[styles.container, { backgroundColor: currentTheme.backgroundColor }]}>
            ...
            >
                <View style={styles.contentContainer}>
                    ...
                    {history.length === 0 ? (
                        <EmptyState currentTheme={currentTheme} isFilterActive={isFilterActive} />
                    ) : (
                        <HistoryList
                            history={history}
                            currentTheme={currentTheme}
