export class ProgressDAO {
    ...
    async set(workId, chapterID, progress) {
        ...
        console.log(
            `Setting progress for workId: ${workId}, chapterID: ${chapterID}, progress: ${validProgress}`,
        );
    ...
    async resetProgress(workId) {
        await this.db.executeSql('DELETE FROM progress_entries WHERE workId = ?', [workId]);
    }
