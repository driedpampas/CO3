...
export const UPDATE_INTERVALS = {
    ...
    EVERY_2_DAYS: {
        label: 'screen_preferences_selector_check_frequency_every_2_days',
        value: 2880,
    },
    EVERY_3_DAYS: {
        label: 'screen_preferences_selector_check_frequency_every_3_days',
        value: 4320,
    },
...
export const UPDATE_RESTRICTIONS = {
    NONE: {
        label: 'screen_preferences_selector_network_restriction_none',
        value: updateRestictionType.None,
    },
    WIFI: {
        label: 'screen_preferences_selector_network_restriction_wifi',
        value: updateRestictionType.Wifi,
    },
    NOT_ROAMING: {
        label: 'screen_preferences_selector_network_restriction_not_roaming',
        value: updateRestictionType.NotRoaming,
    },
};
...
export const DOWNLOAD_WHILE_READING = {
    ...
    THREE_CHAPTERS: {
        label: 'screen_preferences_selector_download_while_reading_next_3',
        value: 3,
    },
    FIVE_CHAPTERS: { label: 'screen_preferences_selector_download_while_reading_next_5', value: 5 },
    TEN_CHAPTERS: {
        label: 'screen_preferences_selector_download_while_reading_next_10',
        value: 10,
    },
};
