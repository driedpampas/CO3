module.exports = {
    ...
    moduleNameMapper: {
        ...
        '^react-native-webview$': '<rootDir>/web-mocks/webview.js',
        '^react-native-screens$': '<rootDir>/web-mocks/screens.js',
        '^@react-native-community/slider$': '<rootDir>/web-mocks/slider.js',
        '^react-native-linear-gradient$': '<rootDir>/web-mocks/linear-gradient.js',
        ...
        '^@react-native-picker/picker$': '<rootDir>/web-mocks/rn-picker.js',
